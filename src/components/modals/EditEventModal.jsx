      ...
      <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full mx-auto relative max-h-[90vh] overflow-y-auto" style={{ borderRadius: '10px', border: '1px solid #8080804a' }}>
        ...
        <div className="p-6">
          ...
          <div className="flex justify-end space-x-4 pt-4 border-t border-gray-200">
            ...
            <button
              onClick={handleSave}
              className={`px-6 py-2 bg-blue-600 text-white rounded-lg transition-colors flex items-center justify-center ${isLoading ? 'opacity-70 cursor-not-allowed' : 'hover:bg-blue-700'}`}
              disabled={isLoading}
            >
              {isLoading ? (
                <>
