...
const ShareEvent = () => {
  ...
  // Toggle for checkbox (Share contact info)
  const handleContactInfoToggle = () => {
    setIsContactInfoChecked(!isContactInfoChecked);
  };
    ...
    <div className="px-6 sm:px-10 lg:px-20 py-6 flex flex-col gap-6">
      ...
      <div className="flex flex-col md:flex-row gap-4 mt-6">
        ...
        <div className="flex-1">
          <div className="flex items-center border border-black rounded-lg p-4 gap-2">
            <div className="flex flex-col w-full">
              <span className="text-sm text-black font-semibold">Radius</span>
              <input
                type="text"
        ...
        <div className="flex-1">
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="text-sm text-black font-semibold">Date</span>
...
<div className="mt-6">
  ...
  <div className="relative">
    ...
    <input
        ...
        className={`appearance-none w-5 h-5 border-2 rounded-sm cursor-pointer 
        ${isContactInfoChecked ? 'bg-black border-black' : 'bg-transparent border-black'} 
        relative flex items-center justify-center`}
    />
    {/* Checkmark (custom overlay) */}
    {isContactInfoChecked && (
        <svg
        className="w-3 h-3 text-white absolute ml-[2px] mt-[2px] pointer-events-none"
        viewBox="0 0 24 24"
        fill="none"
        stroke="currentColor"
        strokeWidth="3"
    ...
    <label className="text-black font-semibold">Share contact information</label>
    </div>

    {/* Animated Contact Info Fields */}
    <div
    className={`transition-all duration-500 overflow-hidden ${
        isContactInfoChecked ? 'max-h-52 opacity-100 mt-4' : 'max-h-0 opacity-0'
    }`}
    >
    ...
    <div className="bg-white p-4 mt-4 flex items-center gap-2 rounded-lg shadow-sm">
        <Info color={'black'} />
...
<div className="mt-6">
  ...
  <input
    ...
    className="w-full appearance-none h-3 bg-transparent shadow-lg rounded-lg"
    style={{
...
<div className="mt-4 bg-white shadow-sm p-4 rounded-lg text-center">
