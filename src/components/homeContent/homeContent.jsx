...
const HomeContent = () => {
  ...
  return (
    <div className="px-6 sm:px-10 lg:px-20 flex flex-col items-center gap-2">
      {/* Logo */}
      <img
      ...
      {/* Paragraph */}
      <p className="text-black font-semibold max-w-4xl">
      ...
      {/* Map */}
      <div className="w-full max-w-4xl h-64 bg-gray-300 rounded-lg">
